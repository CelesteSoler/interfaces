...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const contenedorReiniciar = document.querySelector("#contenedor-reiniciar");
    ...
    buttonStart.addEventListener('click', () => {
        if (!checkFichaDistintas()) {
            ...
            contenedorInicio.style.display = 'none';
            contenedorReiniciar.style.display = "flex";
        ...
        for (let i = 0; i < fichaJUno.length; i++) {
            if (fichaJUno[i].checked) {
                switch (fichaJUno[i].value) {
                    case "1":
                        fichaseleccionada = "img/4inLine/juego/Ficha-brujula.png";
                        return fichaseleccionada;
                    case "2":
                        fichaseleccionada = "img/4inLine/juego/Ficha-calavera.png";
                        return fichaseleccionada;
                    case "3":
                        fichaseleccionada = "img/4inLine/juego/Ficha-catalejos.png";
                        return fichaseleccionada;
                    case "4":
                        fichaseleccionada = "img/4inLine/juego/Ficha-espadas.png";
                        return fichaseleccionada;
                }
            };
        }
